...
title: "Harness GitHub Copilot - Modèle de composants"
order: 140
duration: 60
difficulty: 300
lab_type: local
...
# Harness GitHub Copilot — Modèle de composants

Assemblez un agent sur le harness GitHub Copilot à partir de ses composants — instructions, connaissances, outils, mémoire, Skills et bac à sable de l’agent — puis observez l’orchestrateur décider, se rétablir après une erreur et expliquer ses choix.
...
- [Instructions par cas d’usage](#instructions-par-cas-d-usage)
  - [Cas d’usage nº 1 : Créer un agent sur le harness GitHub Copilot](#cas-1-creer-un-agent)
  - [Cas d’usage nº 2 : L’ancrer dans des sources — connaissances et outils, puis le laisser choisir](#cas-2-connaissances-et-outils)
  - [Cas d’usage nº 3 : Suivre la boucle de raisonnement](#cas-3-boucle-de-raisonnement)
  - [Cas d’usage nº 4 : Un deuxième secteur, rapidement — et une Skill à la demande](#cas-4-deuxieme-secteur-et-skill)
...
**À associer à :** Module 10 — Module dédié : harness GitHub Copilot — Modèle de composants.
...
Ce lab est le complément pratique du **Module 10**, et le plus long du bootcamp — délibérément, car il porte sur le harness dont l’utilisation est supposée acquise pour le reste de la semaine.
...
Les quatre serveurs MCP sont fournis avec ce lab sous forme de packages de solutions Dataverse dans [`Solutions MCP`](Solutions%20MCP/). Ce sont eux que les agents appellent réellement — sans eux, les cas d’usage nº 2, nº 3 et nº 4 ne disposent d’aucune donnée.
...
<a id="verifier-les-solutions-deja-chargees"></a>
...
<a id="documents-de-connaissances"></a>
...
1. Examinez le volet de droite. Tous les composants du Module 10 s’y trouvent : **Model**, **Skills**, **Tools**, **Knowledge**, **Connected agents** et **Memory**. Ce volet concrétise le modèle de composants — pour tout agent, la question de conception est de savoir lequel de ces composants assume quel rôle.
...
<a id="cas-2-connaissances-et-outils"></a>
## 🧱 Cas d’usage nº 2 : L’ancrer dans des sources — connaissances et outils, puis le laisser choisir
...
1. Utilisez la case à cocher d’en-tête — **Toggle selection for all items** — pour sélectionner les deux PDF à la fois, puis **Confirm selection**.
...
<a id="cas-3-boucle-de-raisonnement"></a>
...
<a id="cas-4-deuxieme-secteur-et-skill"></a>
